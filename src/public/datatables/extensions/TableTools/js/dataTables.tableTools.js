...
TableTools.prototype = {
	...
	/**
	 * Programmatically enable or disable the print templates
	 *  @param {boolean} [bView=true] Show the print templates if true or not given. If false, then
	 *    terminate the print templates and return to normal.
	 *  @param {object} [oConfig={}] Configuration for the print templates
	 *  @param {boolean} [oConfig.bShowAll=false] Show all rows in the table if true
	 *  @param {string} [oConfig.sInfo] Information message, displayed as an overlay to the
	 *    user to let them know what the print templates is.
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		if ( oSetDT.oScroll.sX !== "" || oSetDT.oScroll.sY !== "" )
		{
			...
			// If the table redraws while in print templates, the DataTables scrolling
	...
	"_fnPrintScrollStart": function ()
	{
		 ...
		 * in print templates. Note that this section of code is more or less verbatim from DT 1.7.0
		 */
...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Print templates</h6><p>Please use your browser's print function to "+
		  "print this table. Press escape when finished.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "View print templates",
