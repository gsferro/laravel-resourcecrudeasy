...
return [
    ...
    |
    */
    // 'max_mb' => 'O arquivo :attribute deve ser maior que :value MB',
    ...
    'max_mb'               => "O campo :attribute não pode conter um arquivo com mais de :max_mb megabytes.",
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'custom' => [
        ...
        'sobrenomes' => [
            'required'  => 'Necessário informar o nome completo.',
            'min'       => 'Necessário informar o nome completo.',
        ]
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'celular'               => 'Celular',
        'cpf'                   => 'CPF',
        'tipo_email.0'            => 'tipo e-mail',
        'self-documento'        => 'Selfie com Documento',
